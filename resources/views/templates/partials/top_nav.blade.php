    ...
    <div class="container-fluid">
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <nav class="navbar navbar-dark indigo">
            <form action="/dashboard"class="GET">
              <button class="btn btn-outline-white" type="button">Dashboard</button>
            </form>
        </nav>

        @if(auth()->user()->role_id=='6')
        <nav class="navbar navbar-dark indigo">
            <form action="/penjadwalan"class="GET">
              <button class="btn btn-outline-white" type="submit">Penjadwalan</button>
            </form>
        </nav>
        @endif
        ...
        <nav class="navbar navbar-dark indigo">
            <form action="/penjadwalanDosen"class="GET">
              <button class="btn btn-outline-white" type="submit">Penjadwalan</button>
            </form>
        </nav>
        @endif
        ...
        <nav class="navbar navbar-dark indigo">
            <form action="/penjadwalanMahasiswa"class="GET">
              <button class="btn btn-outline-white" type="submit">Penjadwalan</button>
            </form>
        </nav>
        @endif
